defmodule BlockScoutWeb.LayoutView do
  ...
  def logo do
    Keyword.get(application_config(), :logo) || "/images/blockchainbrowser1.svg"
  end

  def logo_footer do
    Keyword.get(application_config(), :logo_footer) || Keyword.get(application_config(), :logo) || "/images/blockchainbrowser_footer.png"
  end
  ...
  def subnetwork_title do
    Keyword.get(application_config(), :subnetwork) || "Chain"
  end
