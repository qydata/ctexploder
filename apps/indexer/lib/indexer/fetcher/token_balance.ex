...
#    Logger.debug("async_fetch_iozhaq", token_balances: token_balances)
...
#    Logger.debug(fn -> ["entries_iozhaq: ", inspect(entries)] end)
    result =
      entries
...
#    Logger.debug(fn -> ["params_list_iozhaq: ", inspect(params_list)] end)
...
#    Logger.debug("format_params_iozhaq",token_id)
    %{
